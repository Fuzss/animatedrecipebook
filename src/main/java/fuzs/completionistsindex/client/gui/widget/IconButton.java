...
public class IconButton extends Button {
    ...
    public void renderButton(PoseStack poseStack, int mouseX, int mouseY, float partialTicks) {
        ...
        blit(poseStack, this.x, this.y, this.xTexStart, this.yTexStart + this.getIconYImage(this.isHoveredOrFocused()) * this.yDiffTex, this.width, this.height, this.textureWidth, this.textureHeight);
