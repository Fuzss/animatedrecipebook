...
public class AttackIndicatorOptionHandler {
    private static final Component ATTACK_INDICATOR_TOOLTIP_COMPONENT = new TextComponent(String.format("Attack Indicator has been disabled by %s mod.", CompletionistsIndex.MOD_NAME));
